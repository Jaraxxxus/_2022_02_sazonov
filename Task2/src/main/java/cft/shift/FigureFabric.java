...
public class FigureFabric {
    ...
    static public Shape createFigure(FigureType type, ArrayList<Double> array) throws InvalidArgumentException
    {
        Shape shape = null;
        switch (type)
        {
    ...
    static public Shape createFigure(double a, double b, double c) throws InvalidArgumentException {
